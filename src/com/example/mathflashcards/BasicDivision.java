...
public class BasicDivision extends Activity 
{
	int a;
	int b;
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		setContentView(R.layout.activity_basic_division);
		answerShowing=false;
		a=r.nextInt(10);
		b=r.nextInt(10);
		firstText=(a*b)+" / "+b+" = ";
	...
	public boolean onCreateOptionsMenu(Menu menu) 
	{
		...
		getMenuInflater().inflate(R.menu.activity_basic_division, menu);
		return true;
	}
	...
	public void buttonPressed(View view)
	{
		if(answerShowing==false)
		{
			...
			second.setText(Integer.toString(a));
